              ...
              <tr key={cart._id}>
                ...
                <td>
                  <div className="flex items-center">
                    <button
                      ...
                      className="bg-sh py-1 px-2 font-bold w-[40px] h-[34px] text-base text-white rounded-l-3xl"
                    >
                      {cartLoadingPlus ? (
                        <>
                    ...
                    <button
                      ...
                      className="bg-red-500 w-[40px] h-[34px] rounded-r-3xl py-1 px-2 font-bold text-base text-white"
                    >
                      {cartLoadingMinus ? (
                        <>
                          <AiOutlineLoading3Quarters className="animate-spin" />
                ...
                <th>
                  <button className="btn btn-ghost btn-xs dark:text-white">
                    TK. {cart?.product_price_per_unit * cart?.product_quantity}
                  </button>
                </th>
                <th>
          ...
          <div className="flex justify-between">
            ...
            <p className="dark:text-white">
              ...
              <span className="text-sh font-bold">
                {subTotal > 1000
                  ? subTotal
                  : parseFloat(subTotal) + deliveryCharge}
              </span>
            </p>
          </div>
          <div className="divider my-0 dark:border-b dark:border-white"></div>
